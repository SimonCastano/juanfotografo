...
<body>
  ...
  <section class="contenido">
    <SECTION class="header">
      ...
      <center>
        <p>INICIA SECION  <br> Esta zona es solo para administradores </p>
      </center>
      <form class="col s12" action="panel_c.php" method="post">
        <br><br><br><br><br>
        <div class="row">
          <div class="row">
        ...
        <center> <button  class="btn waves-effect waves-light grey  white-text" type="submit" name="action">enviar
      ...
      if(isset($guardar)){
        $sql="SELECT * FROM admin  WHERE name='$nom' and pass='$contra'";         
