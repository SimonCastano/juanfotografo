...
<form class="col s12" action="responder.php" method="post">
  ...
  <div class="row">
      ...
      <div class="row">
        ...
        <center> <button  class="btn waves-effect waves-light  grey white-text" type="submit" name="enviar">enviar
  ...
  <div class="row">
    <div class="card  ">
      <div class="card-content white-text" >
        <span class="card-title black-text">Mensaje</span>
        <p class="black-text">Mensaje : <?php  echo "$_SESSION[mensaje]"; ?> </p>
      </div>
     </div>
